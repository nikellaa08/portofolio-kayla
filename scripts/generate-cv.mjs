...
const lines = [
  ...
  { text: "Customer Service & Administrative Support Specialist", size: 11 },
  { text: "", size: 11 },
  ...
  { text: "", size: 10 },
  { text: "SKILLS", size: 13 },
  { text: "Administrative: Word, Excel, Canva, CapCut, Freebuf", size: 10 },
  { text: "Technical: MySQL, PHP, JavaScript, Node.js, Next.js, Tailwind, Git", size: 10 },
  { text: "AI: OpenAI, Gemini", size: 10 },
  { text: "", size: 10 },
  { text: "PROJECTS", size: 13 },
  { text: "Quote of the Day App - Content & Data Maintenance Specialist", size: 10 },
